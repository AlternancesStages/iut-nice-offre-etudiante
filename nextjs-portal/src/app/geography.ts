...
export const CITY_GEOGRAPHY: { [key: string]: { lat: number; lng: number; label: string } } = {
  ...
  "atlanta": { lat: 33.7490, lng: -84.3880, label: "Atlanta (États-Unis)" },
  "bristol": { lat: 51.4545, lng: -2.5879, label: "Bristol (Royaume-Uni)" },
  "riyadh": { lat: 24.7136, lng: 46.6753, label: "Riyadh (Arabie saoudite)" },
  "saint-vulbas": { lat: 45.8340, lng: 5.2930, label: "Saint-Vulbas (France)" },
  "montagny-les-beaune": { lat: 46.9900, lng: 4.8500, label: "Montagny-lès-Beaune (France)" },
